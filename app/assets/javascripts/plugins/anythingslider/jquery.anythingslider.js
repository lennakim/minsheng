...
;(function($, win, doc) {
	...
	$.anythingSlider = function(el, options) {
      ...
      /* custom judge begin */
      if(o.changeBanner){
        base.change_banner_style(base.targetPage, o.changeBannerOption)
			}
			/* custom judge end */
		...
		base.change_banner_style = function(targetPage, element){
	    $(element.remove_class).removeClass(element.class_name);
	    $(element.add_class + targetPage).addClass(element.class_name);
		}
		/*custom function end */
