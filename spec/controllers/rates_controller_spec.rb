  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved rate as @rate" do
        ...
        post :create, {:rate => { "rank" => "invalid value" }}, valid_session
        assigns(:rate).should be_a_new(Rate)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested rate" do
        ...
        Rate.any_instance.should_receive(:update_attributes).with({ "rank" => "1" })
        put :update, {:id => rate.to_param, :rate => { "rank" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the rate as @rate" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Rate.any_instance.stub(:save).and_return(false)
        put :update, {:id => rate.to_param, :rate => { "rank" => "invalid value" }}, valid_session
        assigns(:rate).should eq(rate)
      end
